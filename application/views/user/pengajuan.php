                ...
                <div class="row">
                    <div class="col-md-12 p-2">
                            <div class="card">
                                ...
                                <strong>Form Pengajuan Kenaikan Jabatan</strong>
                                </div>
                                <div class="cara body p-3">
                                    ...
                                    <form action="<?php echo base_url('user/jabatan/pkj')?>" method="post" style="width:1000px" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama" name="nama" value="<?= $log['nama'] ?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="image">Bukti (*pdf, *jpg, png)</label>
                                            <input class="form-control-file" type="file" name="berkas" required/>
