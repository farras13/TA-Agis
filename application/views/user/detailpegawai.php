...
<body id="page-top">
    ...
    <script type="text/javascript">
        $('document').ready(function() {
            ...
            if (isJabatanInclude){
                if (angkaKredit >= kreditJabatan[jabatan]){
                    swal("Mencapai Batas Angka Kredit", "Angka kredit sudah mencapai batas maksimal dan bisa naik jabatan", "success");
                }else {
                    swal("Batas Kredit Belum Memenuhi", "Angka kredit belum mencapai batas maksimal dan belum bisa naik jabatan", "error");
                } 
            }
