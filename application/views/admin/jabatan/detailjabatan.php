									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="float-right">
												<a href="<?php echo base_url('admin/jabatan/laporanjabatanD_pdf/' . $riwayat_jabatan['id_riwayat_jabatan']) ?>" target="__BLANK" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i class="fas fa-file-pdf "></i>
													Laporan PDF
												</a>
											</div>
										</div>
