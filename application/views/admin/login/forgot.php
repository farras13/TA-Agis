              ...
              <div class="col-lg">
                <div class="p-5">
                  ...
                  <img src="<?php echo base_url(); ?>img/logo.png">
                    ...
                    <div class="card-body">
                        <form class="user" method="post" action="<?= base_url('admin/auth/reset_password'); ?>">
                    ...
                    <hr>
                    <div class="text-center">
                        <a class="small" href="<?= base_url('admin/registration'); ?>">Don't have account? Create Now</a> or
